...
class MTAD_GAT(nn.Module):
    def __init__(self, n_features=30, gat_h_dim=128, gru_h_dim=256, rec_h_dim=256, for_h_dim=256, seq_len=64,
                 dropout=0.2):
        ...
        self.forest_model = ForecastModel(in_dim=gru_h_dim * 2, hid_dim=for_h_dim, out_dim=n_features, dropout=dropout)
